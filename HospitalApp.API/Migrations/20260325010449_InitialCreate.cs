        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HospitalSection = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousIllnesses = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-0000-0000-0000-000000000001"), "#E74C3C", "Heart and cardiovascular system", "heart", "Cardiology" },
                    { new Guid("11111111-0000-0000-0000-000000000002"), "#F39C12", "Skin, hair and nails", "skin", "Dermatology" },
                    { new Guid("11111111-0000-0000-0000-000000000003"), "#9B59B6", "Brain and nervous system", "brain", "Neurology" },
                    { new Guid("11111111-0000-0000-0000-000000000004"), "#3498DB", "Bones, joints and muscles", "bone", "Orthopedics" },
                    { new Guid("11111111-0000-0000-0000-000000000005"), "#2ECC71", "Children health", "child", "Pediatrics" },
                    { new Guid("11111111-0000-0000-0000-000000000006"), "#1ABC9C", "General health care", "stethoscope", "General Medicine" },
                    { new Guid("11111111-0000-0000-0000-000000000007"), "#E67E22", "Eyes and vision", "eye", "Ophthalmology" },
                    { new Guid("11111111-0000-0000-0000-000000000008"), "#E91E63", "Women reproductive health", "female", "Gynecology" },
                    { new Guid("11111111-0000-0000-0000-000000000009"), "#607D8B", "Mental health", "mind", "Psychiatry" },
                    { new Guid("11111111-0000-0000-0000-000000000010"), "#795548", "Medical imaging", "xray", "Radiology" }
                });
